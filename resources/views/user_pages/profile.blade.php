    ...
    <div class="h-full w-full md:container">
        ...
        @else
            <div class="mt-12 flex h-full w-full justify-center">
                <div class="h-fit rounded-lg bg-white p-20 text-gray-600 drop-shadow-lg">
                    <h2 class="text-[2rem] font-bold">This content isn't available at the moment</h2>
                    <small>When this happens, it's usually because the user is not available , or it's been
                        deleted.</small>
                </div>
            </div>
        @endif
