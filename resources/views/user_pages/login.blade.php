        ...
        <div class="flex md:h-[32rem] md:w-[55rem]">
            <div
                ...
                <div class="mt-2" x-data="{
                    paragraphs: [
                        'The gateway to a world of knowledge at your fingertips. We believe that knowledge should be easily accessible and available to all. With Theses E-Vault, we\'re here to make that a reality.',
                        ...
                        'Your Key to a World of Wisdom. We\'re the doorway to boundless knowledge, where every click opens a new chapter in your academic journey. At Theses E-Vault, we\'re all about making knowledge accessible, simple, and inspiring.',
                        'Join us in reshaping the way you connect with the wealth of academic insights, where discovery is just a click away.',
                        'We are your gateway to unlocking the profound insights within research and theses. At Theses E-Vault, we\'re dedicated to revolutionizing the way you engage with academia, making it an accessible and enriching experience.'
                    ],
                    currentParagraph: '',
                    currentIndex: 0,
            ...
            <div class="flex flex-col rounded-l-lg rounded-r-lg bg-white p-8 drop-shadow-lg md:w-1/2 md:rounded-l-none">
                <div class="mt-4 flex items-center justify-center gap-2">
                    ...
                    <strong class="text-2xl font-black uppercase text-primary-color">Theses <strong
                            class="text-yellow-500">E-Vault</strong></strong>
                </div>
                <div class="my-4">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="relative w-full">
                                <input class="h-9 w-full rounded-md border-2 bg-gray-200 px-1 focus:outline-blue-950"
                                    ...
                                    required"">
                                <img class="absolute right-2 top-2 h-5" src="{{ asset('Icons/eye-close.png') }}"
                                    id="eyeicon">
                            </div>
                        ...
                        <div class="flex items-center justify-between text-gray-500 md:text-sm lg:text-base">
                            <div class="flex flex-row gap-2">
                                <input type="checkbox" name="remember_me"
                                    id="remember_me"@if (isset($_COOKIE['email'])) checked="" @endif>
