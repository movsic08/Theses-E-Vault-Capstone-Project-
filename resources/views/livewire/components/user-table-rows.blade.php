  <tr>
      ...
      <td class="w-fit text-center">
          <div class="flex items-center justify-center">
              @if ($currentListDataValue->is_verified == 0)
                  <div class="flex w-fit flex-row items-center gap-2 rounded-lg bg-yellow-700 px-2 py-1 text-white">
              ...
              @else
                  <div class="flex w-fit flex-row items-center gap-2 rounded-lg bg-blue-700 px-2 py-1 text-white">
                      <svg class="h-4" viewBox="0 0 23 23" fill="none">
                          <path
      ...
      <td class="relative whitespace-normal px-2 py-3">
          @if ($smallMenu)
              <div
                  ...
                  <div class="flex cursor-pointer items-center gap-1">
                      <svg class="h-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          {{-- @if ($showDeleteConfirmation)
              <div
                  class="fixed inset-0 z-50 flex items-center justify-center bg-gray-300 bg-opacity-25 backdrop-blur-sm">
                  <section class="h-fit w-fit rounded-lg bg-white p-6 drop-shadow-xl">
                      ...
                      <div>
                          <button class="border-bg-red-500 rounded-md border p-2">Cancel</button>
          ...
          @endif --}}
          <svg wire:click='showMenu' class="h-4 cursor-pointer" viewBox="0 0 28 28" fill="currentColor">
              <path
