<div>
            ...
            <div class="flex w-full items-center justify-center">
                <div class="w-[20rem] rounded-md bg-white p-4 drop-shadow-lg">
                    ...
                    <div class="my-1 rounded-md border border-blue-300 bg-blue-100 p-2 text-blue-950">
                        <p class="text-sm font-light">If you don't have a key, you can generate one by visiting the
                            'View Document' page. Simply click on 'Generate Key' and paste it here to unlock. Please
                            note that the generated key is valid for <span class="font-medium">24 hours
                                only.</span></p>
                    </div>
    ...
    <section x-data="{ pdfViewer: false }" x-show="pdfViewer" x-on:open-pdf.window="pdfViewer = true" x wire:ignore>
        ...
        <div class="container relative">
            <div class="relative h-full w-full" x-data="{ isOpen: false, selectedOption: 'Fit to Width' }">




                <div x-data="{ loading: true }" x-on:open-lod="loading = true"
                    class="custom-scrollbar relative col-span-12 mt-2"
                    :class="{ 'h-full': selectedOption !== 'Fit to Width', 'h-[83vh]': selectedOption === 'Fit to Page' }"
                    id="scrollableCanvas">
                    {{-- sticky nav --}}
                    <div class="fixed bottom-3 right-0 z-50 flex w-full items-center justify-center md:pl-[4rem]">
                        <div
                            ...
                            <div class="flex items-center text-sm font-bold text-gray-600">
                                ...
                                <input type="number" id="pageNumberInput" value="1"
                                    class="h-9 w-14 rounded-md border-2 bg-slate-100 px-2 text-center focus:outline-blue-950"
                            ...
                            <div class="relative inline-block text-left">
                                <button @click="isOpen = !isOpen" type="button" id="zoomDropdown"
                                    ...
                                    <svg class="ml-2 hidden h-5 w-5 md:inline-block" fill="none"
                    ...
                    @else
                        <div x-show="loading" class="flex h-full w-full items-center justify-center" id="loadingSpinner"
                            style="display: none">
                            <div
                                class="container mt-14 w-[80%] rounded-xl bg-white p-5 drop-shadow-md md:w-[40%] md:p-10">
                        ...
                        <div class="h-full w-auto">
                            <canvas class="mx-auto" id="pdfArea" style="height: 100%; width: fit;"></canvas>
                        </div>
                    @endif
                </div>
