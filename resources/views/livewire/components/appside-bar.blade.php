<div class="relative hidden md:block" wire:ignore>
    ...
    <nav id="sidebar-nav"
        class="sticky bottom-0 left-0 top-0 z-40 flex h-screen flex-col items-center justify-between rounded-r-xl bg-white p-2 font-medium text-gray-700 drop-shadow-xl dark:bg-black lg:p-3">
        {{-- app name and logo --}}
