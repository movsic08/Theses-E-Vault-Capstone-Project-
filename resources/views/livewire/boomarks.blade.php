<div class="container flex flex-col justify-center">
    ...
    @else
        <section class="flex h-[34.5rem] w-full flex-col gap-4 rounded-lg bg-white px-8 py-6 drop-shadow-lg">
            @foreach ($bookmarkLists as $bookmarkedItem)
                <div class="flex items-center gap-4">
                    {{-- <h1> <strong>user_id:</strong>{{ $bookmarkedItem->user_id }}</h1>
                    <h1><strong>docu post id:</strong> {{ $bookmarkedItem->docu_post_id }}</h1>
                    <h1> <strong>id in DB:</strong>{{ $bookmarkedItem->id }}</h1>
                    <h1> <strong>reference:</strong>{{ $bookmarkedItem->reference }}</h1> --}}
                    @php
                    ...
                    <div class="flex flex-col gap-1 md:flex-row">
                        <button
                            class="rounded-lg bg-blue-800 p-2 text-white duration-200 ease-in-out hover:bg-blue-900">
                        ...
                        <button
                            ...
                            class="rounded-lg bg-red-700 p-2 text-white duration-200 ease-in-out hover:bg-red-800">
