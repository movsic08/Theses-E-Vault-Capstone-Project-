    ...
    <div class="container">
        ...
        <section class="relative grid grid-flow-row-dense grid-cols-4 gap-4 text-primary-color lg:mx-8">
            ...
            <div class="col-span-4 flex flex-col gap-3 lg:col-span-3">
                ...
                {{-- comment form --}}
                @include('livewire.partials.comment-area')
            </div>
            ...
            <div
                ...
                <div class="grid grid-cols-4 gap-3">
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-center">
                                ...
                                <div class="flex w-full flex-col gap-2">
                                    ...
                                    @php
                                        $pdfFileData = $data->document_file_url;
                    ...
                    <div class="col-span-2 rounded-lg bg-white p-4 drop-shadow-lg lg:col-span-4">
                        ...
                        <div class="flex items-center justify-center">
                            <svg wire:click="citeMe" class="h-9 w-10 cursor-pointer rounded-md bg-blue-600 p-1" viewBox="0 0 46 46" fill="none">
                                <path
