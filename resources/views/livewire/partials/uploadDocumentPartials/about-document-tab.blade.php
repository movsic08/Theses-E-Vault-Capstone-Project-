  <div class="text-gray-700">
      ...
      <section class="flex flex-col gap-2">
          <div class="flex w-full flex-col">
              ...
              <x-input-field class="w-full" wire:model.live="title" id="title" placeholder="Title of your work" />
              @error('title')
          ...
          <div class="flex w-full flex-col gap-2 md:mt-2 md:flex-row md:gap-4">
              <div class="flex flex-col md:w-1/2">
                  ...
                  @else
                      <x-input-field class="w-full" type="text" wire:model.live="bachelor_degree_value"
                          placeholder="{{ auth()->user()->is_admin ? 'Degree name' : '' }}" id="bachelor_degree"
          ...
          <div class="flex w-full flex-col gap-2 md:mt-2 md:gap-4 lg:flex-row">
              ...
              <div class="flex w-full flex-col gap-2 md:flex-row md:gap-4 lg:w-1/2">
                  <div class="flex flex-col md:w-1/2">
                      ...
                      <x-input-field class="w-full" type="text" wire:model.live="physical_description"
          ...
          <div class="mt-2 flex w-full flex-col gap-2 md:flex-row md:gap-4">
              <div class="flex flex-col md:w-1/2">
                  ...
                  <x-input-field class="w-full" type="text" wire:model.live="panel_chair" id="panel_chair"
              ...
              <div class="flex flex-col md:w-1/2">
                  ...
                  <x-input-field class="w-full" type="text" wire:model.live="advisor" id="advisor"
          ...
          <div class="mt-2 flex w-full flex-col gap-2 md:gap-4">
              ...
              <div class="flex flex-col gap-2 md:flex-row md:gap-4">
                  <div class="w-full">
                      <x-input-field class="w-full" type="text" wire:model.live="panel_member1" id="panel_member"
                  ...
                  <div class="w-full">
                      <x-input-field class="w-full" type="text" wire:model.live="panel_member2" id="panel_member"
              ...
              <div class="flex flex-col gap-2 md:flex-row md:gap-4">
                  <div class="w-full">
                      <x-input-field class="w-full" type="text" wire:model.live="panel_member3" id="panel_member"
                  ...
                  <div class="w-full">
                      <x-input-field class="w-full" type="text" wire:model.live="panel_member4" id="panel_member"
