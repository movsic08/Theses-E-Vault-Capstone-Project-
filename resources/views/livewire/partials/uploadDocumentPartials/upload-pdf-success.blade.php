  <div x-data="{ isSuccess: false }" x-show="isSuccess" x-on:open-suc.window="isSuccess = true"
      ...
      <div class="mt-16 flex w-full flex-col items-center rounded-lg bg-white p-4 shadow-lg md:w-[40%] lg:w-[30%]">
          <h1 class="text-center text-xl font-semibold uppercase text-primary-color">File is uploaded</h1>
          <p class="mx-4 my-2 rounded-md border bg-blue-100 px-3 py-2 text-sm text-blue-800 md:mx-6 lg:mx-8">
              Admin will
              review
