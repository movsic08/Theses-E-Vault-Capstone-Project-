 <div class="sticky gap-3 text-primary-color lg:col-span-3 lg:flex lg:flex-col">
         ...
         <div class="container mt-2">
                         ...
                         <div class="w-full">
                             <div class="flex w-full flex-col leading-tight">
                                 <div class="flex w-full justify-between">
                                     <strong class="texts">{{ $fullname }}</strong>
                                     <section class="flex gap-1">
                                         ...
                                         @if ($commentAuthorDetails->role_id == 1)
                                             <span class="text-xs font-medium md:text-sm">Student</span>
                                         @elseif($commentAuthorDetails->role_id == 1)
                                             <span class="text-xs font-medium md:text-sm">Faculty</span>
                                         @else
                                             <span class="text-xs font-medium md:text-sm">ERROR!</span>
                                         @endif
                                     </section>
                                 </div>
             ...
             @foreach ($replyComments as $replyCommentsItem)
                 @if ($replyCommentsItem->parent_id == $commentsItem->id)
                     ...
                     @else
                         <div class="ml-5 mt-2 rounded-xl bg-white px-4 py-2 drop-shadow-md" wire:poll.10s="$refresh">
                             @php
                                             ...
                                             <div class="flex items-start gap-1">
                                                 @php
                                                     ...
                                                     if ($nameOfReplyingComment) {
                                                         $fullNameOfRepliedCommentFNameOnly = $nameOfReplyingComment->first_name;
                                                 ...
                                                 @endphp
                                                 <strong
                                                     class="whitespace-nowrap text-xs md:text-base">{{ $fullNameOfMainComment }}</strong>
                                                 <small class="hidden text-xs md:block md:text-base">replying to
                                                     {{ $fullNameOfRepliedComment }}</small>
                                                 <small class="text-xs md:hidden md:text-base">replying to
                                                     {{ $fullNameOfRepliedCommentFNameOnly }}</small>
                                             </div>
                                             <section class="flex gap-1">
                                                 <div class="flex items-center gap-1">
                                                 ...
                                                 @if ($commentMainAuthorID)
                                                     ...
                                                     @endif
                                                 @else
                                                     <span class="text-xs font-medium md:text-sm">Deleted user</span>
                                                 @endif
                                         ...
                                         <ul class="flex gap-2 text-xs">
                                             @if (auth()->check())
                                                 ...
                                                 @if ($replyCommentsItem->user_id !== auth()->user()->id)
                                                     ...
                                                     <li wire:click='showReportBox({{ $replyCommentsItem->id }})'
                                                         class="cursor-pointer transition duration-200 ease-in-out hover:font-semibold">
                                                         Report</li>
                                                 @endif
                                             @endif
