            ...
            <div
                ...
                <div class="mx-3 flex w-fit flex-col gap-1 rounded-md bg-white px-10 py-5 text-center md:w-2/5">
                    ...
                    <section class="text-sm text-red-700">
                        <p>This action is irreversible and will permanently delete all your data associated with this
                            account. If you proceed, you will lose access to your account and all its contents.
                            Please take a moment to consider this decision. If you're certain about deleting your
                            account,
                            click the "Delete Account" button below.</p>
                    </section>
                    <div class="flex justify-center">
                        <input type="text" id="confirmInput" class="rounded-md border border-gray-400 p-2"
                            placeholder="Confirm, by typing DELETE" id="">
                        <div id="indicator"
                            class="my-auto ml-2 flex hidden h-8 w-8 items-center justify-center rounded-full bg-gray-200">
                            <!-- Indicator content will be added here -->
                        </div>
                    </div>
                    <div class="flex w-full flex-col gap-2 md:flex-row">
                        <button wire:click='showdelBox'
                            class="w-full rounded-md bg-gray-600 p-1 text-white duration-200 ease-in hover:bg-gray-700">Cancel</button>
                        <button wire:click="deletemyAccount" id="confirmBTN"
                            class="w-full rounded-md bg-red-400 p-1 text-white" disabled>Yes, Delete
                            it</button>
                    </div>
        ...
        <section class="w-full lg:w-3/5">
            <div
                ...
                <button wire:click="setActiveTab('tab1')"
                    class="{{ $activeTab === 'tab1' ? 'border-b-4 border-primary-color py-3 pt-5 font-bold' : '' }}">General
                </button>
                <button wire:click="setActiveTab('tab2')"
                    class="{{ $activeTab === 'tab2' ? 'border-b-4 border-primary-color py-3 pt-5 font-bold' : '' }}">Security
                </button>
                <button wire:click="setActiveTab('tab3')"
                    class="{{ $activeTab === 'tab3' ? 'border-b-4 border-primary-color py-3 pt-5 font-bold' : '' }}">Links
                </button>
                <button wire:click="setActiveTab('tab4')"
                    class="{{ $activeTab === 'tab4' ? 'border-b-4 border-primary-color py-3 pt-5 font-bold' : '' }}">Files
                </button>
            </div>
            <div>
                @if ($activeTab === 'tab1')
                    ...
                    <div
                        ...
                        <form wire:submit.prevent="changePassword" wire:loading.class="loading">
                            <section class="flex flex-col gap-2">
                                ...
                                <div class="flex w-full flex-col">
                                    <label class="text-sm font-semibold" for="password">New
                                        password</label>
                                    <input class="rounded-md border border-gray-400 p-2 text-sm" type="password"
                        ...
                        <form action="">
                            <section class="flex flex-col gap-2">
                                ...
                                <p class="text-sm">
                                    ...
                                    deleted.
                                    hBefore deleting your account, please download any data or information that you wish
                                    to
                                    retain.
                                </p>
                                <a class="w-full">
                    ...
                    <div
                            ...
                            <form>
                                <div class="flex w-full flex-col">
                                    ...
                                    <input class="rounded-md border border-gray-400 p-2 text-sm" type="text"
                                        wire:model="facebook_url" value="{{ $user->facebook_url }}" id="fb_url">
                                    @error('facebook_url')
                                        <small class="text-red-500">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="flex w-full flex-col">
                                    ...
                                    <input class="rounded-md border border-gray-400 p-2 text-sm" type="text"
                                        wire:model="ms_url" value="{{ $user->ms_url }}" id="ms_url">
                                    @error('ms_url')
                                        <small class="text-red-500">{{ $message }}</small>
                                    @enderror
                                </div>
                        ...
                        <section>
                            ...
                            <div class="flex h-fit items-center justify-center">
                                ...
                                <p class="text-xs text-red-600">Your account is not yet verified. To access all
                                    features, please
                                    verify your account
                                    to confirm you are a student status at PSU-ACC. Binding your institutional email
                                    account will help you to recover your account.</p>
                            </div>
                            <div class="flex w-full flex-col">
                                <label class="text-sm font-semibold" for="ms_url">Institutional Email</label>
                                <small>To verify your account, you need to use your institutional account.</small>
                                <input class="rounded-md border border-gray-400 p-2 text-sm" type="text"
                                    wire:model="ms_url" value="{{ $user->ms_url }}" id="ms_url">
                                @error('ms_url')
                                    <small class="text-red-500">{{ $message }}</small>
