<div class="container">
    <div class="px-2">
        ...
        <div class="mt-2 overflow-x-auto">
            ...
            <div class="mt-2 divide-y divide-gray-200 bg-white">
                <h2>Hello</h2>
            </div>
            <table class="min-w-full divide-y rounded-lg drop-shadow-lg">
                <!-- Table Head -->
                <thead>
                    <tr>
                        <th
                ...
                <!-- Table Body -->
                <tbody class="d divide-y divide-gray-200 bg-white">
                    <tr>
