<div>
    <div class="container">
        ...
        <div class="mb-8 rounded-2xl bg-white px-5 py-2 drop-shadow-md">
            <div class="relative mb-2 flex w-full flex-col items-center justify-between px-4 py-2 md:flex-row">
                            ...
                            <tbody class="w-full text-gray-500">
                                @foreach ($currentListData as $currentListDataValue)
                                    <tr>
                                        ...
                                        <td class="flex items-center justify-center whitespace-normal px-6 py-2">
                                            @if ($currentListDataValue->is_verified == 0)
                                                <div
                                                    class="flex w-fit flex-row items-center gap-1 rounded-lg bg-yellow-700 px-2 py-1 text-white">
                                            ...
                                            @else
                                                <div
                                                    class="flex w-fit flex-row items-center gap-1 rounded-lg bg-blue-700 px-2 py-1 text-white">
                                                    <svg class="h-4" viewBox="0 0 23 23" fill="none">
                                                        <path
