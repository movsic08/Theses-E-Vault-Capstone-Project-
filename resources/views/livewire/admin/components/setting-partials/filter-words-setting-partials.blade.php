<section>
    <div class="flex w-full items-end justify-between">
        ...
        <button wire:click.prevent='openAddNewSensitiveWord'
                ...
                <div class="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            @foreach ($filterwords as $item)
                                <tr>
                                    <td class="whitespace-nowrap px-6 py-4 font-medium text-red-800">
                                        {{ $item->word }}
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-sm font-medium">
                                        <div class="flex w-full items-center justify-center gap-1">
                                            <svg wire:click='editSensitiveWord({{ $item->id }})'
                                            ...
                                            <svg wire:click='showDeleteSensitiveWordBox({{ $item->id }})'
