  <div x-data="{ filterWords: true }" x-show="filterWords" x-on:open-fw.window = "filterWords = true"
      x-on:close-fw.window = "filterWords = false" x-on:keydown.escape.window = "filterWords = false"
      ...
      <section
          ...
          <strong
              class="w-full text-center uppercase text-primary-color">{{ $editingFilterWords ? 'Editing ' : 'Add new ' }}senstive
              word</strong>
