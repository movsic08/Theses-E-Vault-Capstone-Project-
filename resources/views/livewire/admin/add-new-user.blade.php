<div class="container">
    ...
    <table class="z-10 w-full rounded-b-xl">
...
<div id="mainContainer" class="hidden">
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-20 backdrop-blur-sm">
        <form wire:submit="addNewUser" id="addUserForm" name="addUserForm" autocomplete="off" method="POST">
            @csrf
                ...
                <div class="flex flex-grow flex-col p-3">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input class="h-9 rounded-md border-2 bg-gray-200 px-1 focus:outline-blue-950" type="text"
                            wire:model.live="username" id="username" placeholder="ezname902" value="{{ old('username') }}">
                        @error('username')
                    ...
                    <div class="flex flex-col">
                        ...
                        <input class="h-9 rounded-md border-2 bg-gray-200 px-1 focus:outline-blue-950" type="email"
                            wire:model.live="email" id="email" placeholder="user@psu.edu.ph"
                            value="{{ old('email') }}">
                        @error('email')
                            <span class="w-full px-1 text-xs text-red-700">
                                {{ $message }}
                    ...
                    <div class="flex flex-col">
                        ...
                        <select wire:model.live="account_level" id="account-level"
                ...
                <div id="leftContainer" class="flex hidden flex-col p-3">
                    ...
                    <div class="hidden" id="user-form">
                        ...
                        <div class="flex flex-col">
                            ...
                            <select wire:model.live="role_id" id="account-role"
                                class="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input class="h-9 rounded-md border-2 bg-gray-200 px-1 focus:outline-blue-950"
                                type="text" wire:model.live="first_name" id="first_nameUser" placeholder="John"
                                value="{{ old('first_name') }}">
                        </div>
                        <div class="flex flex-col">
                            <label class="font-medium" for="last_nameUser">Last name</label>
                            <input class="h-9 rounded-md border-2 bg-gray-200 px-1 focus:outline-blue-950"
                                type="text" wire:model.live="last_name" id="last_nameUser" placeholder="John"
                                value="{{ old('last_name') }}">
                        </div>
                        <div class="flex flex-col">
                            <label class="font-medium" for="student_idUser">Student ID</label>
                            <input class="h-9 rounded-md border-2 bg-gray-200 px-1 focus:outline-blue-950"
                                type="text" wire:model.live="student_id" id="student_idUser" placeholder="John"
                                value="{{ old('student_id') }}">
                        </div>
                        <div class="flex flex-col">
                            <label class="font-medium" for="profile_pictureUser">Profile picture</label>
                            <input class="h-9 rounded-md border-2 bg-gray-200 px-1 focus:outline-blue-950"
                                type="file" wire:model.live="profile_picture" id="profile_pictureUser"
                                placeholder="John" value="{{ old('profile_picture') }}">
                        </div>
                        <div class="flex flex-col">
                            <label class="font-medium" for="bachelor_degree">Bachelor Degree</label>
                            <select wire:model.live="bachelor_degree" id="bachelor-degree"
                                class="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input class="h-9 rounded-md border-2 bg-gray-200 px-1 focus:outline-blue-950"
                                type="text" wire:model.live="bio" id="bio" placeholder="John"
                                value="{{ old('bio') }}">
                        </div>
                        <div class="flex gap-2">
                    ...
                    <div class="hidden" id="admin-form">
                        <div class="flex flex-col">
                            ...
                            <input class="h-9 rounded-md border-2 bg-gray-200 px-1 focus:outline-blue-950"
                                type="text" wire:model.live="first_name" id="first_name" placeholder="John"
                                value="{{ old('first_name') }}">
                        </div>
                        <div class="flex flex-col">
                            <label class="font-medium" for="last_name">Last name</label>
                            <input class="h-9 rounded-md border-2 bg-gray-200 px-1 focus:outline-blue-950"
                                type="text" wire:model.live="last_name" id="last_name" placeholder="John"
                                value="{{ old('last_name') }}">
                        </div>
                        <div class="flex flex-col">
                            <label class="font-medium" for="student_id">Faculty ID</label>
                            <input class="h-9 rounded-md border-2 bg-gray-200 px-1 focus:outline-blue-950"
                                type="text" wire:model.live="student_id" id="student_id" placeholder="John"
                                value="{{ old('student_id') }}">
                        </div>
                        <div class="flex flex-col">
                            <label class="font-medium" for="profile_picture">Profile picture</label>
                            <input class="h-9 rounded-md border-2 bg-gray-200 px-1 focus:outline-blue-950"
                                type="file" wire:model.live="profile_picture" id="profile_picture" placeholder="John"
