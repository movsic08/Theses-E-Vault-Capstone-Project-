                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="font-medium text-gray-600">
                            @foreach ($currentListData as $currentListDataValue)
                                ...
                                <tr :key="$currentListDataValue - > id">
                                    ...
                                    <td class="w-fit text-center">
                                        <div class="flex w-full items-center justify-center">
                                            @if ($currentListDataValue->is_verified == 0)
                                                <div
                                                    class="flex w-full flex-row items-center justify-center gap-2 rounded-lg bg-yellow-700 px-2 py-1 text-white">
                                            ...
                                            @else
                                                <div
                                                    class="flex w-full flex-row items-center justify-center gap-2 rounded-lg bg-blue-700 px-2 py-1 text-white">
                                                    <svg class="h-4" viewBox="0 0 23 23" fill="none">
                                                        <path
