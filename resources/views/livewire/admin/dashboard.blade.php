    ...
    <section class="container">
        ...
        <div class="grid grid-cols-10 gap-6">
            ...
            <div class="col-span-10 flex h-full flex-col gap-2 md:col-span-5 lg:col-span-2">
                <div
                    class="overflow-hidden rounded-lg bg-primary-color p-4 text-white drop-shadow-lg duration-500 ease-in-out hover:scale-110">
            ...
            <div class="col-span-10 rounded-lg bg-white p-4 text-gray-600 drop-shadow-lg lg:col-span-8">
                <h2 class="font-medium">New uploaded files</h2>
                <section class="">
                    <table class="w-full">
                        <tbody wire:poll.5000ms="loadDashboard">
