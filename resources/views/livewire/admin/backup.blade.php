<section class="">
    <div class="my-2 flex flex-col justify-between gap-2 md:flex-row">
        <div class="flex gap-6 text-xs text-primary-color lg:text-base">
            <button class="{{ $currentQuery == 'allUsers' ? 'border-b-2 border-primary-color font-bold' : '' }}">All
                users</button>
            <button
        ...
        <div class="flex gap-4 text-xs lg:text-base">
            <div wire:click='openNewDepartmentBox'
                ...
                Departments</div>
            <div wire:click='showAddUserBox' class="cursor-pointer rounded-lg bg-primary-color p-1 px-3 text-white">Add
                user</div>
        </div>
    </div>
    <div
        class="lg:max-h-1.5> <div class= mb-8 flex w-full flex-col items-center justify-between gap-2 overflow-y-auto rounded-2xl bg-white px-5 py-2 py-2 drop-shadow-md md:flex-row">
        ...
        <div class="flex items-center">
            ...
            <div class="relative max-w-sm">
                <label for="datePicker" class="absolute inset-y-0 left-0 flex cursor-pointer items-center pl-3.5">
    ...
    <div class="custom-scrollbar overflow-x-auto">
        <div class="max-h-[35rem]">
            <table class="> <thead> <tr class= min-w-full"font-semibold capitalize">
                                ...
                                @else
                                    @if ($currentListDataValue->role_id == 1)
                                        @if (!empty($currentListDataValue->bachelor_degree))
                                            {{ $bachelorDegree->name }}
                                        @else
                                            <span class="text-red-700"><strong>No
                                                    Info</strong></span>
                                        @endif
                                    @elseif($currentListDataValue->role_id == 2)
                                        <span>Faculty</span>
                            ...
                            <td class="relative whitespace-normal px-2 py-3 text-sm md:text-base">
                                <div class="mx-1 flex gap-1 md:mx-2">
                                    <div
                                        ...
                                        <svg class="h-4 text-white" fill="currentColor" viewBox="0 0 24 24"
                                    ...
                                    <div wire:click='showDeleteBoxUser("{{ $currentListDataValue->id }}")'
                                        ...
                                        <span>
                                            <svg class="h-4 text-white" viewBox="0 0 18 20" fill="currentColor">
                                                <path
