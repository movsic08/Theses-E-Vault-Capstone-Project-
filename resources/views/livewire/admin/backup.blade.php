<section class="md:gradient-bg-light sticky top-0 z-30 bg-slate-100 bg-opacity-70 p-2 backdrop-blur-md">
    <div class="container">
        <div class="container top-0 flex w-full items-center justify-between text-base font-semibold text-blue-950">
            @php
        ...
        {{-- mobile version --}}
        <div class="relative">
            <div id="mobileMenu" class="absolute hidden h-screen w-screen bg-slate-100 backdrop-blur-sm">
