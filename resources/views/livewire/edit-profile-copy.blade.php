<div>
        ...
        <div
            ...
            <div
                ...
                <form action="" wire:submit="deleteDocuPostYes">
                    <input type="text" hidden wire:model.live="deletedPostTitle" value="{{ $postitle }}">
                    <input type="text" hidden wire:model.live="deletedPostID " value="{{ $docuPostID }}">
    ...
    <div wire:loading wire:target="profile_picture"
        ...
        <div
            class="mx-3 flex w-fit flex-col gap-1 rounded-xl bg-white px-10 py-8 text-center text-gray-600 drop-shadow-lg md:w-3/5 lg:w-4/12">
            <h2>Uploading profile picture...</h2>
        </div>
    </div>
    <x-session_flash />
                ...
                <div class="flex flex-col items-center justify-center gap-2">
                    <div class="relative">
                        ...
                        <div
                            ...
                            <input wire:model.live="profile_picture" type="file" id="profile_picture" hidden />
                        </div>
                    </div>
