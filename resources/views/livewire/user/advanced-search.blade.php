<div>
    ...
    <section class="container">
        <div class="mt-14 flex h-full flex-col items-center justify-center md:mt-[4rem] md:p-2">
            <div class="flex w-full flex-col items-center justify-center">
                ...
                <h2
                    class="mx-[2rem] mt-4 text-center text-lg font-extrabold text-primary-color dark:text-slate-100 md:mt-7 md:text-2xl lg:mx-[10rem] lg:text-4xl">
                    UNLOCKING
                    ACADEMIC
                    INSIGHTS:
                    EXPLORE
            ...
            <div class="my-4 flex flex-col gap-2 md:gap-4">
                ...
                <div x-data="{ dateOption: 'month-and-year-only' }" x-data="{ dateOption: '' }"
                    class="gradient-border flex flex-col items-center justify-center gap-2 rounded-xl border border-gray-200 bg-slate-100 bg-opacity-30 p-3 shadow-xl backdrop-blur-md dark:border-slate-800 dark:bg-gray-900 dark:bg-opacity-10 md:mx-0 md:gap-4 md:p-6 lg:px-10 lg:py-6"
                    for="search-docu">
                    {{-- search input --}}
                    <div class="flex w-full">
                        <input
                            class="h-10 w-[18rem] rounded-l-full border-b-2 border-l-2 border-t-2 px-4 font-medium drop-shadow-md focus:border-gray-400 focus:outline-none dark:border-gray-800 dark:bg-slate-800 dark:text-slate-100 dark:focus:border-gray-700 md:w-full lg:h-14 lg:w-[30.8rem]"
                        ...
                        <div class="flex w-full flex-col items-start justify-between gap-2 md:flex-row">
                            <div class="flex w-full flex-col items-start justify-start gap-1 md:w-fit">
                                ...
                                <div class="flex w-full flex-row items-center justify-start md:flex-col">
                                    <label for="dateOpt"
                                        class="mr-1 block whitespace-nowrap text-sm font-medium text-gray-700 dark:text-slate-100 md:mr-0">Start
                                        Date Option</label>
                                    <select id="dateOpt" x-model="dateOption" wire:model.live='datepicker'
                                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500 md:w-fit">
                            ...
                            <div x-show="dateOption === 'month-and-year-only'"
                                ...
                                <div class="flex w-full flex-row items-start md:flex-col">
                                    <label for="monthYear"
                                        class="mr-1 block w-fit whitespace-nowrap text-left text-sm font-medium text-gray-700 dark:text-slate-100">Month
                                        and
                                        Year:</label>
                                    <input type="month" id="monthYear" name="monthYear" wire:model='dateMYOnly'
                                        class="w-full rounded-md border border-gray-300 p-1.5 focus:border-blue-500 focus:outline-none dark:bg-slate-800 dark:text-slate-100">
                                </div>
                            </div>
                            ...
                            <div x-show="dateOption === 'date-range'" x-transition:enter.duration.400ms.delay.300ms
                                ...
                                <div class="flex w-full flex-col items-center gap-2 md:flex-row md:justify-center">
                                    ...
                                    <div class="flex w-full flex-row items-center md:flex-col">
                                        <label for="endDate"
                                            class="mr-1 block whitespace-nowrap text-sm font-medium text-gray-700 dark:text-slate-100">End
                                            Date:</label>
                    ...
                    <div class="flex w-full flex-row items-center justify-start gap-2">
                        <div class="flex w-full flex-col items-center gap-1 md:flex-row md:gap-2">
                            <x-label-input class="whitespace-nowrap dark:text-slate-100">Document type</x-label-input>
                        ...
                        <div class="flex w-full flex-col items-center gap-1 md:flex-row md:gap-2">
                            <x-label-input class="dark:text-slate-100">Language</x-label-input>
                ...
                <a href="{{ route('user-search') }}" wire:navigate
                    class="flex w-fit items-center justify-center gap-1 rounded-md border border-blue-700 bg-blue-100 bg-opacity-30 px-2 py-1 text-xs font-extrabold text-blue-200 backdrop-blur-sm duration-200 ease-in-out hover:bg-blue-800 hover:text-white dark:border-none md:px-2 md:py-1 md:text-base">
    ...
    <svg class="svg-bg dark:background-dark -z-10 h-full w-full" version="1.1" xmlns="http://www.w3.org/2000/svg"
