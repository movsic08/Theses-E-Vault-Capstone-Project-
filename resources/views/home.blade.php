<x-app-layout>
    ...
    <div class="container my-2 flex flex-col space-y-4 md:flex-row md:gap-2 md:space-y-0 lg:space-x-10">
        <div class="space-y-2 md:w-1/2 md:space-y-3 lg:w-full lg:space-y-6">
            <div
                class="flex rounded-md bg-white p-2 drop-shadow-lg duration-300 hover:-translate-y-1 hover:drop-shadow-2xl lg:items-center lg:justify-center">
                {{-- svg  --}}
                ...
                <div>
                    <div class="whitespace-normal font-semibold text-secondary-color lg:text-sm">Using internet of
                        things (IoT)
                        to
                        knowledge
                        management to improve
                        organizational performances: A case study on selected companies from different industries in the
                        Philippines</div>
                    <div class="flex text-sm text-white">
                        <div class="mx-1 rounded bg-blue-700 px-2">Capstone</div>
                        <div class="rounded bg-blue-900 px-2">BSIT</div>
                    </div>
                    <div class="flex">
                        ...
                        <ul class="flex w-auto flex-wrap text-sm">
                            <li class="inline">Jude Emmanuel Thaddeus Q. Altamarino,
                            <li class="inline">Marvin Jerome T. Chua, </li>
                            <li class="inline">Lucas C. Nicdao, </li>
                            <li class="inline">and Pablo Isidro N. Pagkatipunan</li>
                            </li>
                        </ul>
                    </div>
                    <div class="flex">
            ...
            <div
                class="flex rounded-md bg-white p-2 drop-shadow-lg duration-100 hover:-translate-y-1 hover:drop-shadow-2xl lg:items-center lg:justify-center">
                {{-- svg  --}}
                <div class="hidden w-1/4 lg:block">
                    <svg fill="currentColor" viewBox="0 0 24 24">
                        <path
        ...
        <div class="md:w-1/2 lg:w-1/3">
            <div class="space-y-3 md:sticky md:top-20 lg:space-y-3">
                <div class="rounded-md bg-white drop-shadow-lg">
                    <h2 class="rounded-t-md bg-gray-700 p-2 text-center font-semibold text-white">New uploaded
                        Documents
                    </h2>
                    <div class="px-2">
                        <div class="flex items-center justify-center border-b-2 border-solid border-gray-500 py-2">
                            <p class="truncate text-sm">The Effect of Unicorn Tears on Human Emotional
                                Resilience: A
                                Comparative
                                Study
                            </p>
                            <span class="rounded bg-green-700 px-1 text-xs text-white">Research</span>
                        </div>
                        <div class="flex items-center justify-center border-b-2 border-solid border-gray-500 py-2">
                            <p class="truncate text-sm">The Effect of Unicorn Tears on Human Emotional Resilience: A
                                Comparative
                                Study
                            </p>
                            <span class="rounded bg-blue-700 px-1 text-xs text-white">Capstone</span>
                        </div>
                        <div class="flex items-center justify-center border-b-2 border-solid border-gray-500 py-2">
                            <p class="truncate text-sm">The Effect of Unicorn Tears on Human Emotional Resilience: A
                                Comparative
                        ...
                        <div class="flex items-center justify-center border-b-2 border-solid border-gray-500 py-2">
                            ...
                            <span class="rounded bg-yellow-700 px-1 text-xs text-white">Feasib</span>
                        </div>
                        <div class="flex items-center justify-center py-2">
                            ...
                            <span class="rounded bg-blue-700 px-1 text-xs text-white">Thesis</span>
                        </div>
                    </div>
                </div>
                <div class="rounded-md bg-white drop-shadow-lg">
                    <h2 class="rounded-t-md bg-gray-700 p-2 text-center font-semibold text-white">New Post
                    </h2>
                    <div class="px-2">
                        <div class="flex items-center justify-center border-b-2 border-solid border-gray-500 py-2">
                            <p class="truncate text-sm">The Effect of Unicorn Tears on Human Emotional Resilience: A
