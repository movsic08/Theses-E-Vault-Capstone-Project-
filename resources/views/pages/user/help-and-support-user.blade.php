    ...
    <div>
        <section class="container">
            <div class="flex h-full flex-col items-center justify-center md:p-2">
                ...
                <p
                    class="mx-[2rem] mt-4 w-full rounded-lg border border-blue-200 px-4 py-2 text-justify text-sm text-primary-color drop-shadow-md backdrop-blur-sm md:w-[85%] md:px-6 md:py-4 lg:w-[60%] lg:text-base">
                    Welcome to our
            ...
            <div class="mt-20 flex w-full items-center justify-center">
                <div class="flex w-fit flex-col items-start justify-center gap-2">
                    ...
                    <div class="flex flex-col items-start justify-center gap-8 text-primary-color md:flex-row">
                        <div
                            class="flex h-[16rem] w-[16rem] flex-col items-center justify-center rounded-lg bg-slate-200 p-6 drop-shadow-lg">
