      ...
      <div class="mx-auto">
          <section class="h-fit w-fit rounded-lg bg-white p-6 drop-shadow-xl">
              @if ($deleteDepartmentBox)
                  <div class="fixed left-0 top-0 h-full w-full rounded-lg bg-gray-900 bg-opacity-40 backdrop-blur-sm">
                              ...
                              <form wire:submit.prevent='editDepartment' class="flex w-full flex-col gap-2">
                                  ...
                                  <div class="flex w-full flex-col">
                                      <label class="text-sm font-semibold" for="dn">Department
                                          Name</label>
                                      <input class="w-full rounded-md border border-gray-400 p-2 text-sm" type="text"
                                          wire:model.live="degree_nameEdit" id="dn"
