...
(function (global, factory) {
            ...
            var bySet = setMatchers.length > 0,
                ...
                superMatcher = function (
                    ...
                    var elem,
                        ...
                        elems =
                            seed ||
                            (byElement && jQuery.expr.find.TAG("*", outermost)),
        ...
        when: function (singleValue) {
            ...
            if (remaining <= 1) {
                ...
                if (
                    ...
                    typeof (resolveValues[i] && resolveValues[i].then) ===
                        "function"
                ) {
                    return primary.then();
                }
    ...
    function adjustCSS(elem, prop, valueParts, tween) {
        var adjusted,
            ...
            unit =
                (valueParts && valueParts[3]) || (isAutoPx(prop) ? "px" : ""),
            ...
            if (
                ...
                for (i = 0, l = srcElements.length; i < l; i++) {
                    ...
                    if (nodeName(destElements[i], "textarea")) {
                        destElements[i].defaultValue =
                            srcElements[i].defaultValue;
                    }
                }
            }
    ...
    jQuery.extend({
        ...
        style: function (elem, name, value, extra) {
            ...
            if (value !== undefined) {
                ...
                if (type === "number") {
                    value +=
                        (ret && ret[3]) || (isAutoPx(origName) ? "px" : "");
                }
