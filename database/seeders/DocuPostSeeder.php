    ...
    public function run(): void {
        ...
        foreach ( range( 1, 50 ) as $index ) {
            ...
            DB::table( 'docu_posts' )->insert( [
                ...
                'document_type' => $faker->randomElement( [ 'Thesis', 'Capstone', ' Research', 'Dissertation' ] ),
                ...
                'author_1' => $faker->name,
                'author_2' => $faker->optional()->name,
                'author_3' => $faker->optional()->name,
                'author_4' => $faker->optional()->name,
