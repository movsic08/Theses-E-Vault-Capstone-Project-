...
class AdminUsersPanel extends Component {
    ...
    public function switchToVerifiedUsersData() {
        ...
        return $this->currentListData = User::where( 'is_verified', 1 )->get();
    }
    ...
    protected $listeners = [ 'userCreated' => 'updateList' ];

    public function updateList( $query ) {
    ...
    private function loadUserList( $query ) {
        switch ( $query ) {
            case 'allUsers':
            $this->currentListData = $this->switchToAllUsersData();
            break;
            case 'verifiedUsers':
            $this->currentListData = $this->switchToVerifiedUsersData();
            break;
            case 'unverifiedUsers':
            $this->currentListData = $this->switchToUnverifiedUsers();
            break;
            case 'adminUsers':
            $this->currentListData = $this->switchToAdminUsers();
            break;
        }
    }
